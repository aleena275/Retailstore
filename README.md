...
1. **Router:** Placed first and connected to the switch for central network management.
2. **Cashier PCs:** Added two cashier PCs for billing, connected to the switch with IP addresses assigned.
3. **Manager PC:** Added for managerial tasks and inventory monitoring, connected to the switch.
4. **Printer:** Placed for printing bills and reports, connected to the switch.
5. **Inventory PC:** Added to manage stock, connected to the switch.
6. **CCTV (simulated with PCs):** Two PCs simulate CCTV monitoring for security, connected to the switch.
...
* Cisco Networking Academy. “Cisco Packet Tracer.” [NetAcad](https://www.netacad.com/courses/getting-started-cisco-packet-tracer)
